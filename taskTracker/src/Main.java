public class Main {
    public static void main(String[] args) {
        ...
        inMemoryTaskManager.createSubtaskInEpic(0, "Subtask1", "This is first subtask in epic 1"); //id: 4
        inMemoryTaskManager.createSubtaskInEpic(0, "Subtask2", "This is second subtask in epic 1"); //id: 5
        inMemoryTaskManager.createSubtaskInEpic(1, "Subtask1", "This is first subtask in epic 2"); //id: 6
